// Here is my attempt to rework the day2 solution using objects and function chaining.
...
const day2 = {
  ...
  splitIt: function () {
    let manipulatedStr = this.result.slice(str.indexOf("task. ") + 6);
    this.result = manipulatedStr.split("v");
    return this;
  },
  collectCharacters: function () {
    this.result = this.result.map((a) => a[0]).join("");
    return this.result;
  },
};
